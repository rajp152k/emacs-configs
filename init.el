...
;;evil-collection : yet to figure out
...
(general-define-key "M-j" 'ace-jump-mode)
...
(defun gtd()
  (interactive)
  (find-file (concat org-directory "/gtd/NA.org")))
...
;; pasting in emacs : paste the configs from webapge here
;; do not type
...
(defun blog ()
  (interactive)
  (find-file "~/links/source/blog/rajp152k.github.io"))
(general-define-key
 "C-c b" 'blog)
...
(custom-set-variables
 ...
 '(org-agenda-files
   '("/mnt/c/Users/Raj Patil/source/org/gtd/wait.org" "/mnt/c/Users/Raj Patil/source/org/gtd/tickler.org" "/mnt/c/Users/Raj Patil/source/org/gtd/NA.org")))
